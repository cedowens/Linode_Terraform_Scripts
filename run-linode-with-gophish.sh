...
read linodeName
echo "=====>Enter the src IP that you will login to your C2 infra from (i.e., terraform will set up a firewall only allowing ssh and gophish port 3333 admin access in from this src IP"
read adminIP
...
cd Linode_new_ubuntu_with_gophish
